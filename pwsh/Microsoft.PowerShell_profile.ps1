...
# Clear env variables on exiting the powershell
Register-EngineEvent PowerShell.Exiting -Action { Clear-EnvironmentVariables }
...
Set-Alias wifi readwifinearme
Set-Alias viewdb view-main-database
Set-Alias rt remove-task
Set-Alias at insert-task
Set-Alias q "exit(0)"
Set-Alias cal Get-Calendar
Set-Alias internet Get-InternetStatus

# Prompt
oh-my-posh init pwsh --config 'C:\Users\pradi\OneDrive\Documents\PowerShell\oh-my-posh\adimail.omp.json' | Invoke-Expression
